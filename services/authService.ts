...
import { Auth, LoginResponse, resetPassword, updateMypassword, updateProfile } from '@/types/userType';
...
export const authService = {
  ...
  async updateMypassword(data:updateMypassword ) {
    try {
      await api.put('api/update-my-password', data);
      toast.success('Mot de passe modifier avec succes ')
